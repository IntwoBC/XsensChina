codeunit 50000 "Event Subscriber"
{
    ...
    begin
        ...
        SalesHeader."IC Payment Terms" := ICInboxSalesHeader."US Payment terms";                         // 20160512 KBG 06458
        SalesHeader."IC Sales Order No." := ICInboxSalesHeader."US Sales Order number";                    // 20160512 KBG 06458
